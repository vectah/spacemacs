...
you should place your code here."
  ...
  ;; edit server for edit with emacs chrom extension ======================
  (require 'edit-server)
  (edit-server-start)
